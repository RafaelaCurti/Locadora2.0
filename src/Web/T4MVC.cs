...
namespace T4MVC
{
    ...
    public class ClienteClass
    {
        ...
        public Locadora.Web.Areas.Cliente.Controllers.FilmesController Filmes = new Locadora.Web.Areas.Cliente.Controllers.T4MVC_FilmesController();
        public Locadora.Web.Areas.Cliente.Controllers.HomeController Home = new Locadora.Web.Areas.Cliente.Controllers.T4MVC_HomeController();
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class PainelClass
    {
        public readonly string Name = "Painel";
        public Locadora.Web.Areas.Painel.Controllers.BaseController Base = new Locadora.Web.Areas.Painel.Controllers.T4MVC_BaseController();
        public Locadora.Web.Areas.Painel.Controllers.ClientesController Clientes = new Locadora.Web.Areas.Painel.Controllers.T4MVC_ClientesController();
        public Locadora.Web.Areas.Painel.Controllers.FilmesController Filmes = new Locadora.Web.Areas.Painel.Controllers.T4MVC_FilmesController();
        public Locadora.Web.Areas.Painel.Controllers.GenerosController Generos = new Locadora.Web.Areas.Painel.Controllers.T4MVC_GenerosController();
        public Locadora.Web.Areas.Painel.Controllers.HomeController Home = new Locadora.Web.Areas.Painel.Controllers.T4MVC_HomeController();
        public Locadora.Web.Areas.Painel.Controllers.ItensController Itens = new Locadora.Web.Areas.Painel.Controllers.T4MVC_ItensController();
        public Locadora.Web.Areas.Painel.Controllers.LivrosController Livros = new Locadora.Web.Areas.Painel.Controllers.T4MVC_LivrosController();
        public Locadora.Web.Areas.Painel.Controllers.ReservasController Reservas = new Locadora.Web.Areas.Painel.Controllers.T4MVC_ReservasController();

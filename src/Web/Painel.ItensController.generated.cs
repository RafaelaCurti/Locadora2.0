...
namespace Locadora.Web.Areas.Painel.Controllers
{
    public partial class ItensController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ItensController Actions { get { return MVC.Painel.Itens; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _excluir = "~/Areas/Painel/Views/Itens/_excluir.cshtml";
            public readonly string _form = "~/Areas/Painel/Views/Itens/_form.cshtml";
            public readonly string _listar_filmes = "~/Areas/Painel/Views/Itens/_listar-filmes.cshtml";
            public readonly string _listar_reservas = "~/Areas/Painel/Views/Itens/_listar-reservas.cshtml";
            public readonly string cadastrar = "~/Areas/Painel/Views/Itens/cadastrar.cshtml";
            public readonly string editar = "~/Areas/Painel/Views/Itens/editar.cshtml";
            public readonly string Index = "~/Areas/Painel/Views/Itens/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ItensController : Locadora.Web.Areas.Painel.Controllers.ItensController
    {

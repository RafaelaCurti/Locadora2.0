...
namespace Locadora.Web.Areas.Painel.Controllers
{
    public partial class FilmesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FilmesController Actions { get { return MVC.Painel.Filmes; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _buscar = "~/Areas/Painel/Views/Filmes/_buscar.cshtml";
            public readonly string _excluir = "~/Areas/Painel/Views/Filmes/_excluir.cshtml";
            public readonly string _form = "~/Areas/Painel/Views/Filmes/_form.cshtml";
            public readonly string _listar_generos = "~/Areas/Painel/Views/Filmes/_listar-generos.cshtml";
            public readonly string cadastrar = "~/Areas/Painel/Views/Filmes/cadastrar.cshtml";
            public readonly string editar = "~/Areas/Painel/Views/Filmes/editar.cshtml";
            public readonly string Index = "~/Areas/Painel/Views/Filmes/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FilmesController : Locadora.Web.Areas.Painel.Controllers.FilmesController
    {
        ...
        [NonAction]
        partial void BuscarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Locadora.Web.Areas.ViewModels.MovieSearchViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Buscar(Locadora.Web.Areas.ViewModels.MovieSearchViewModel model)
        {
